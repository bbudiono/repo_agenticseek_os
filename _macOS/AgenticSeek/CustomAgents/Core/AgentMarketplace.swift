...
/**
 * Purpose: Marketplace for sharing and discovering custom agents
...
class AgentMarketplace: ObservableObject {
    static let shared = AgentMarketplace()
