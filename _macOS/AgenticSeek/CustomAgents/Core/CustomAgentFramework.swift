...
/**
 * Purpose: Core framework for creating and managing custom agents
...
class CustomAgentFramework: ObservableObject {
    static let shared = CustomAgentFramework()
...
extension CustomAgentFramework {
