...
/**
 * Purpose: Executes custom agent workflows and task sequences
...
class AgentWorkflowEngine: ObservableObject {
    static let shared = AgentWorkflowEngine()
