...
/**
 * Purpose: Integration layer connecting custom agents to main app
...
class CustomAgentIntegration: ObservableObject {
    static let shared = CustomAgentIntegration()
...
extension CustomAgentIntegration {
