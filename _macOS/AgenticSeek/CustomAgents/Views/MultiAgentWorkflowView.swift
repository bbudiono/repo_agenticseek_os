...
/**
 * Purpose: UI for managing multi-agent workflows and coordination
...
struct MultiAgentWorkflowView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("MultiAgentWorkflow")
        .onAppear {
            loadData()
        }
