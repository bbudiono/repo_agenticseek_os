...
/**
 * Purpose: Main UI for designing custom agents with visual tools
...
struct CustomAgentDesignerView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("CustomAgentDesigner")
        .onAppear {
            loadData()
        }
        ...
        VStack(alignment: .leading, spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    Text("MLACS: CustomAgentDesigner")
                        .font(.headline)
                        .foregroundColor(.primary)
