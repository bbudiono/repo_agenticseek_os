...
/**
 * Purpose: Integration layer connecting tiered system to main app
...
class TieredArchitectureIntegration: ObservableObject {
    static let shared = TieredArchitectureIntegration()
